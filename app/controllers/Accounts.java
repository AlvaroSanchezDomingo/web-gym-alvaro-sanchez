...
public class Accounts extends Controller
{
    ...
    public static void registertrainer(String name, String gender, String email, String password, String address)
    {
        Logger.info("Registering new trainer " + email);
        Trainer trainer = new Trainer(name, gender, email, password, address);
        trainer.save();
        redirect("/");
    }
